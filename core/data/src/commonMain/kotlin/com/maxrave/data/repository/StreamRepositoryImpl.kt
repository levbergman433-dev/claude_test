...
internal class StreamRepositoryImpl(
    ...
    override fun getStream(
        ...
        flow {
            ...
            // High (Premium 256 kbps) always uses the logged-in extraction; see YouTube.resolveStreams.
            youTube.fastStreamPath = dataStoreManager.fastStreamLoading.first() == DataStoreManager.TRUE
            youTube.wantsPremiumAudio = itag == ITAG.AUDIO_OPUS_HIGH || itag == ITAG.AUDIO_AAC_HIGH
            youTube
